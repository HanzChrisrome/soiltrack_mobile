...
class AiAnalysisWeekly extends ConsumerWidget {
  final Map<String, dynamic> analysis;

  const AiAnalysisWeekly({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final recommendedCrops = analysis['recommended_crops'] as List<dynamic>;
            ...
            child: Column(
              ...
              children: [
                ...
                CarouselSlider(
                  ...
                  items: recommendedCrops.map((cropData) {
                    final crop = cropData['crop'];
                    final reason = cropData['reason'];
                    return Builder(
